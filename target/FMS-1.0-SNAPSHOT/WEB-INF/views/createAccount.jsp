<%-- 
    ...
    Created on : May 24, 2023, 4:24:39 PM
    Author     : Kavishika
--%>
<%
...
<html>
    <head>
        ...
        <title>FMS | Create Account </title>
    <!-- Bootstrap -->
    ...
    <jsp:include page="headerSign.jsp"></jsp:include>
     <body class="body bg-light">
        ...
        <form name="contactform" id="contactform" action="account/create" style="padding-bottom: 50px;" method="post">
          ...
          <div class="fields">
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="initDeposit" id="initDeposit" placeholder="Enter Value" />
              </div>
            </div>
