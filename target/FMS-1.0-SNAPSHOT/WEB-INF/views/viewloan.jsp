        ...
        <body class="body bg-light">
            <div class="container  min-vh-100" style="background-color: #081624;">
                ...
                <table class="table">
                    ...
                    <c:forEach var="accounts" items="${loanList}">
                    <tr>
                        <td><a href="loanrepayment?id=<c:out value="${accounts.account_id}" />&bal=<c:out value="${accounts.value}" />"> <c:out value="${accounts.account_id}" /></a></td>
                    </tr>
                </c:forEach>
            </table>
        </div>
