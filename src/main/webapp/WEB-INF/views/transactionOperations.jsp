<%-- 
    Document   : transactionOperations
    Created on : May 24, 2023, 4:25:05 PM
    Author     : Kavishika
--%>
<%
...
<html>
    ...
    <jsp:include page="headerSign.jsp"></jsp:include>
     <body class="body bg-light">
        ...
        <form name="contactform" id="contactform" action="account/transactioninit" style="padding-bottom: 50px;" method="post">
